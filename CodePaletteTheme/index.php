  ...
  <section id="works" class="works top-works top-layout">
    <div class="works__inner inner">
      ...
      <div class="works__heading">
        <p>
          制作実績の一例です。クリックすると詳細ページが開きます。<br>
      ...
      <div class="works__contents-wrapper">
        <ul class="works__items works-cards">
          ...
          <li class="works__item">
            <a href="#" class="works-card" data-modal="modal-06"> <!-- Changed button to a -->
              <figure class="works-card__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/syurinouta-OGP.png" alt="しゅりのうたHPトップ画像" width="800" height="600">
              </figure>
              <div class="works-card__body">
                <h3 class="works-card__heading">「しゅりのうたプロジェクト - タイランド」様 <br class="u-desktop">ホームページ</h3>
                <p class="works-card__sub-heading">（タイ国内プロジェクトサイト）</p>
              </div>
            </a>
          </li>
          <!-- RARA Japan様 -->
          <li class="works__item">
            <a href="#" class="works-card" data-modal="modal-01"> <!-- Changed button to a -->
              <figure class="works-card__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/rara-japan.png" alt="RARA Japanのロゴ画像" width="800" height="600">
              </figure>
              <div class="works-card__body">
                <h3 class="works-card__heading">RARA Japan様<br>ホームページ</h3>
                <p class="works-card__sub-heading">（インドネシア向け事業サイト）</p>
              </div>
            </a>
          </li>
          <!-- TENSAKU LP型サイト -->
          <li class="works__item">
            <a href="#" class="works-card" data-modal="modal-02"> <!-- Changed button to a -->
              <figure class="works-card__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/shogo-ogp.jpg" alt="TENSAKUサイトのFV画像" width="800" height="600">
              </figure>
              <div class="works-card__body">
                <h3 class="works-card__heading">"TENSAKU" LP型サイト</h3>
                <p class="works-card__sub-heading">（架空の添削ソフトサービスサイト）</p>
              </div>
            </a>
          </li>
          <!-- キャリアパートナーズサイト -->
          <li class="works__item">
            <a href="#" class="works-card" data-modal="modal-05"> <!-- Changed button to a -->
              <figure class="works-card__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/career-support.png" alt="キャリアサポートサイトFV" width="800" height="600">
              </figure>
              <div class="works-card__body">
                <h3 class="works-card__heading">"キャリアパートナーズ"ホームページ</h3>
                <p class="works-card__sub-heading">（架空のキャリアサポートサイト）</p>
              </div>
            </a>
          </li>
          <!-- ダイビングサイト -->
          <li class="works__item">
            <a href="#" class="works-card" data-modal="modal-03"> <!-- Changed button to a -->
              <figure class="works-card__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/codeups-diving.png" alt="CodeUps Diving ホームページFV" width="800" height="600">
              </figure>
              <div class="works-card__body">
                <h3 class="works-card__heading">"CodeUps - Diving" ホームページ</h3>
                <p class="works-card__sub-heading">（架空のダイビングサイト）</p>
              </div>
            </a>
          </li>
          <!-- 石井花壇サイト -->
          <li class="works__item">
            <a href="#" class="works-card" data-modal="modal-04"> <!-- Changed button to a -->
              <figure class="works-card__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/hotel-ishii.jpg" alt="石井花壇FV" width="800" height="600">
              </figure>
              <div class="works-card__body">
                <h3 class="works-card__heading">石井花壇ホームページ</h3>
                <p class="works-card__sub-heading">（架空のホテルサイト）</p>
              </div>
            </a>
          </li>
        </ul>
      ...
      <!-- モーダル(①RARA Japan) -->
      <div class="works__modal works-modal js-works-modal" data-modal-id="modal-01">
        <div class="works-modal__inner">
          <!-- 閉じるボタン -->
          <button class="works-modal__close-button js-works-modal__close-button" aria-label="RARA Japanのモーダルを閉じる">
          ...
          <div class="works-modal__container">
            ...
            <div class="works-modal__contents-wrapper"></div>
            <!-- モーダルの中のカード -->
            <div class="works-modal__card">
              <figure class="works-modal__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/rara-japan.png" alt="RARA Japanホームページの画像" width="800" height="600">
              </figure>
              <h3>RARA Japan様 ホームページ</h3>
              <a href="https://rara-japan.com/" target="_blank" rel="noopener noreferrer" class="works-modal__client-url">URL: https://rara-japan.com/</a>
            </div>
            <!-- モーダルの中の詳細 -->
            <div class="works-modal__details">
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">クライアント</dt>
                <dd class="works-modal__text">RARA Japan様</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作時間</dt>
                <dd class="works-modal__text">コーディング約50時間（納期約3ヶ月）</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">使用言語</dt>
                <dd class="works-modal__text">HTML/CSS/jQuery/php</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">担当範囲</dt>
                <dd class="works-modal__text">ライティング、翻訳校正、デザイン、コーディング</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作背景</dt>
                <dd class="works-modal__text">
            ...
            <div class="works-modal__button-to-list">
              <a href="#works" class="button button--to-works-list">
                <span>実績一覧</span>
              </a>
            </div>
          </div>
      ...
      <!-- モーダル(⑥しゅりのうたタイランド) -->
      <div class="works__modal works-modal js-works-modal" data-modal-id="modal-06">
        <div class="works-modal__inner">
          <!-- 閉じるボタン -->
          <button class="works-modal__close-button js-works-modal__close-button" aria-label="しゅりのうたのモーダルを閉じる">
            <span class="works-modal__close01"></span>
            <span class="works-modal__close02"></span>
          </button>
          <div class="works-modal__container">
            ...
            <div class="works-modal__card">
              ...
              <h3>しゅりのうたプロジェクト - タイランド様 ホームページ</h3>
              <a href="https://syurinouta-thailand.com/" target="_blank" rel="noopener noreferrer" class="works-modal__client-url">URL: https://syurinouta-thailand.com/</a>
            </div>
            <!-- モーダルの中の詳細 -->
            <div class="works-modal__details">
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">クライアント</dt>
                <dd class="works-modal__text">「しゅりのうたプロジェクト - タイランド」様</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作時間</dt>
                <dd class="works-modal__text">コーディング約50時間（納期約3ヶ月）</dd>
              ...
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">担当範囲</dt>
                <dd class="works-modal__text">プロジェクト企画・運営、ライティング、翻訳・校正、コーディング</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作背景</dt>
                <dd class="works-modal__text">
      ...
      <!-- モーダル(②TENSAKU) -->
      <div class="works__modal works-modal js-works-modal" data-modal-id="modal-02">
        <div class="works-modal__inner">
          <!-- 閉じるボタン -->
          <button class="works-modal__close-button js-works-modal__close-button" aria-label="TENSAKUのモーダルを閉じる">
            <span class="works-modal__close01"></span>
            <span class="works-modal__close02"></span>
          </button>
          <div class="works-modal__container">
            ...
            <div class="works-modal__card">
              <figure class="works-modal__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/shogo-ogp.jpg" alt="TENSAKU LPサイトHP" width="800" height="600">
              </figure>
              <h3>"TENSAKU" LP型サイト</h3>
              <a href="https://naoko-test.site/tensaku/" target="_blank" rel="noopener noreferrer" class="works-modal__client-url">URL: https://naoko-test.site/tensaku/</a>
            </div>
            <!-- モーダルの中の詳細 -->
            <div class="works-modal__details">
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">クライアント</dt>
                <dd class="works-modal__text">架空の添削ソフトサービスサイト</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作時間</dt>
                <dd class="works-modal__text">約50時間 (納期約2週間)</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">使用言語</dt>
                <dd class="works-modal__text">HTML/CSS/jQuery</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">担当範囲</dt>
                <dd class="works-modal__text">コーディング</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作背景</dt>
                <dd class="works-modal__text">
                  トップページ＋下層６ページのLP型事業サイトです。ハンバーガーメニュー、スライダー、アコーディオンなどの基本的な実装以外に、資料請求と利用申し込みのフォーム、資料ダウンロード機能などを実装いたしました。フォームはもちろん、キーボード操作のみで入力・送信ができるよう、アクセシビリティーにも考慮しました。
                </dd>
              </dl>
            </div>
            <!-- 実績一覧 ボタン -->
      ...
      <!-- モーダル(③CodeUps Divingサイト) -->
      <div class="works__modal works-modal js-works-modal" data-modal-id="modal-03">
        <div class="works-modal__inner">
          <!-- 閉じるボタン -->
          <button class="works-modal__close-button js-works-modal__close-button" aria-label="CodeUps Divingのモーダルを閉じる">
            <span class="works-modal__close01"></span>
            <span class="works-modal__close02"></span>
          </button>
          <div class="works-modal__container">
            ...
            <div class="works-modal__card">
              <figure class="works-modal__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/codeups.png" alt="CodeUps Divingサイトトップページ画像" width="800" height="600">
              </figure>
              <h3>"CodeUps Diving" 事業サイト</h3>
              <a href="https://naoko-test.site/codeups-diving/" target="_blank" rel="noopener noreferrer" class="works-modal__client-url">URL: https://naoko-test.site/codeups-diving/</a>
              <div class="works-modal__access">
                <p>ユーザー名:naoko-codeups</p>
                <p>パスワード:codeups-diving2405#</p>
              </div>
            ...
            <div class="works-modal__details">
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">クライアント</dt>
                <dd class="works-modal__text">架空のダイビング事業サイト</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作時間</dt>
                <dd class="works-modal__text">約100時間 (納期約4週間)</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">使用言語</dt>
                <dd class="works-modal__text">HTML/CSS/JavaScript/jQuery/php</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">担当範囲</dt>
                <dd class="works-modal__text">コーディング、CMS（WordPress）実装中</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作背景</dt>
                <dd class="works-modal__text">
      ...
      <!-- モーダル(④石井花壇ホームページ) -->
      <div class="works__modal works-modal js-works-modal" data-modal-id="modal-04">
        <div class="works-modal__inner">
          <!-- 閉じるボタン -->
          <button class="works-modal__close-button js-works-modal__close-button" aria-label="石井花壇のモーダルを閉じる">
            <span class="works-modal__close01"></span>
            <span class="works-modal__close02"></span>
          </button>
          <div class="works-modal__container">
            ...
            <div class="works-modal__card">
              <figure class="works-modal__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/hotel-ishii.jpg" alt="石井花壇HPトップページ画像" width="800" height="600">
              </figure>
              <h3>"石井花壇" ホームページ</h3>
              <a href="https://naoko-test.site/hotel-ishii/" target="_blank" rel="noopener noreferrer" class="works-modal__client-url">URL: https://naoko-test.site/hotel-ishii/</a>
            </div>
            <!-- モーダルの中の詳細 -->
            <div class="works-modal__details">
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">クライアント</dt>
                <dd class="works-modal__text">架空のホテルサイト</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作時間</dt>
                <dd class="works-modal__text">約40時間 (納期約2週間)</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">使用言語</dt>
                <dd class="works-modal__text">HTML/CSS/jQuery</dd>
              ...
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作背景</dt>
                <dd class="works-modal__text">
                  トップページ＋下層３ページの、縦書きを含む和風のホテルサイトです。アコーディオン、タブの他、宿泊予約をモーダルで実装しました。
                </dd>
              </dl>
            </div>
            <!-- 実績一覧 ボタン -->
      ...
      <!-- モーダル(⑤キャリアパートナーズホームページ) -->
      <div class="works__modal works-modal js-works-modal" data-modal-id="modal-05">
        <div class="works-modal__inner">
          <!-- 閉じるボタン -->
          <button class="works-modal__close-button js-works-modal__close-button" aria-label="キャリアパートナーズのモーダルを閉じる">
            <span class="works-modal__close01"></span>
            <span class="works-modal__close02"></span>
          </button>
          <div class="works-modal__container">
            ...
            <div class="works-modal__card">
              <figure class="works-modal__image-wrapper">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/career-support.png" alt="キャリアパートナーズHPトップページ画像" width="800" height="600">
              </figure>
              <h3>"キャリアパートナーズ" ホームページ"</h3>
              <a href="https://naoko-test.site/career-support/" target="_blank" rel="noopener noreferrer" class="works-modal__client-url">URL: https://naoko-test.site/career-support/</a>
            </div>
            <!-- モーダルの中の詳細 -->
            <div class="works-modal__details">
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">クライアント</dt>
                <dd class="works-modal__text">架空のキャリアサポートサイト</dd>
              </dl>
              <dl class="works-modal__details-wrapper">
                <dt class="works-modal__index">制作時間</dt>
                <dd class="works-modal__text">約40時間 (納期約2週間)</dd>
