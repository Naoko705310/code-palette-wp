  ...
  <section id="concept" class="concept top-concept top-layout">
    <div class="concept__inner inner">
      ...
      <div class="concept__intro">
        <p>
          昨今はインバウンド需要の高まりとともに、さまざまな背景を持つユーザーがWebサイトを訪れるようになりました。
        </p>
        <p>
          シンプルでわかりやすい構成はもちろんのこと、多様なユーザーに配慮したアクセシビリティと多言語対応の重要性が一層高まっています。
        </p>
        <p>
          Webサイトの多言語対応は、外国人のお客様だけのためのものではありません。
        </p>
        <p>
          言葉だけでなく<span class="concept__highlight">「誰にでもわかりやすい構成や案内」</span>を見直すきっかけにもなり、<br class="u-desktop">
            ...
            <?php while ($works_query->have_posts()): $works_query->the_post(); ?>
              ...
              <li class="works__item">
                <a href="#" class="works-card js-works-modal-open" data-modal-id="<?php echo $modal_id; ?>">
                  ...
                  <h3 class="works-card__heading"><?php echo nl2br(get_the_title()); ?></h3>
